...
uchf-website/
├── index.html       Home
├── about.html        About Us — vision, mission, background, values, FAQ
...
└── js/
    ├── main.js        Nav menu, accordion, tabs, story filter, lightbox, copy buttons, contact form
...
- **Navigation** — sticky header, active-page highlighting, mobile hamburger menu.
- **Stories filter** — buttons actually filter the story grid by year (2018 / 2020 / 2025).
- **Lightbox** — click any story photo to view it full-size; Esc or click-out to close.
...
- **WhatsApp button** — floating button links to `wa.me/254713134184`, a real chat link.
